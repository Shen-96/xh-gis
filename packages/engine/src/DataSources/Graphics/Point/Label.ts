...
export class Label extends AbstractPoint {
  ...
  constructor({
    ...
    this.graphicType = GraphicType.LABEL;
    this.graphicName = "标签";
...
// 模块内自注册
registry.registerGraphic(GraphicType.LABEL, Label as any);
